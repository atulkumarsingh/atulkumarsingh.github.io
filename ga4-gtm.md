...
<section class="relative py-10 md:py-14 overflow-hidden bg-[#0d1117] border-b border-gh-border-dark">
    <!-- Background Glow -->
        ...
        <div class="flex flex-wrap justify-center gap-x-6 gap-y-3 mb-10 text-[15px] font-semibold text-gh-fg-dark">
            ...
            <span class="flex items-center gap-2"><span class="material-symbols-outlined text-gh-green text-[18px]">check_circle</span> Data-Driven Decisions</span>
        </div>
        ...
        <p class="text-[14px] text-gh-muted-dark italic font-medium">No guesswork. Just clean, reliable data.</p>
    </div>
</section>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div class="bg-[#0d1117] border border-gh-border-dark rounded-2xl p-8 md:p-10 hover:border-gh-red/30 transition-colors reveal">
                ...
                <h2 class="text-2xl font-bold text-gh-fg-dark mb-4 tracking-tight">Why Your Data Is Misleading You</h2>
                <p class="text-[16px] text-gh-muted-dark mb-6">Most businesses are making decisions based on broken tracking:</p>
                ...
                <ul class="space-y-4 mb-8">
                    <li class="flex items-start gap-3 text-[16px] text-gh-fg-dark font-medium">
                        ...
                        GA4 doesn’t match Google Ads data
                    </li>
                    <li class="flex items-start gap-3 text-[16px] text-gh-fg-dark font-medium">
                        <span class="material-symbols-outlined text-gh-red shrink-0 select-none">close</span>
                    ...
                    <li class="flex items-start gap-3 text-[16px] text-gh-fg-dark font-medium">
                        <span class="material-symbols-outlined text-gh-red shrink-0 select-none">close</span>
                        Reports look good, but revenue doesn’t match
                    </li>
                </ul>
                
                <div class="pt-6 border-t border-gh-border-dark text-[18px] font-bold text-gh-red">
                    If your data is wrong, your entire strategy is wrong.
                </div>
            </div>
            ...
            <div class="bg-[#0d1117] border border-gh-border-dark rounded-2xl p-8 md:p-10 hover:border-gh-green/30 transition-colors reveal reveal-delay-1">
                ...
                <h2 class="text-2xl font-bold text-gh-fg-dark mb-4 tracking-tight">A Complete Tracking System — Not Just GA4 Setup</h2>
                <p class="text-[16px] text-gh-muted-dark mb-6">I build a connected tracking system ecosystem:</p>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-[#161b22] border border-gh-border-dark rounded-xl p-8 hover:border-gh-green/40 transition-colors reveal">
                ...
                <ul class="space-y-2 text-[14px] text-gh-muted-dark font-medium">
                    ...
                    <li>• Broken tags & triggers</li>
                    <li>• Clear fix roadmap</li>
                </ul>
            </div>
            ...
            <div class="bg-[#161b22] border border-gh-border-dark rounded-xl p-8 hover:border-gh-green/40 transition-colors reveal">
                ...
                <ul class="space-y-2 text-[14px] text-gh-muted-dark font-medium">
                    ...
                    <li>• Scalable tracking architecture</li>
                </ul>
            </div>
            ...
            <div class="bg-[#161b22] border border-gh-border-dark rounded-xl p-8 hover:border-gh-green/40 transition-colors reveal">
                ...
                <ul class="space-y-2 text-[14px] text-gh-muted-dark font-medium">
                    ...
                    <li>• Multi-step funnel tracking</li>
                </ul>
            </div>
            ...
            <div class="bg-[#161b22] border border-gh-border-dark rounded-xl p-8 hover:border-gh-green/40 transition-colors reveal">
                ...
                <ul class="space-y-2 text-[14px] text-gh-muted-dark font-medium">
                    ...
                    <li>• Cross-platform event mapping</li>
                </ul>
            </div>
...
<section class="py-10 md:py-14 bg-[#010409] border-b border-gh-border-dark">
    <div class="max-w-5xl mx-auto px-4 sm:px-6">
        <div class="bg-[#161b22] border border-gh-border-dark rounded-2xl p-8 md:p-12 shadow-sm reveal">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between border-t border-gh-border-dark pt-8">
                <div class="flex flex-col sm:flex-row gap-4 sm:gap-8 mb-4 md:mb-0">
                    <span class="text-gh-fg-dark font-bold text-[15px] flex items-center gap-2"><span class="material-symbols-outlined text-gh-green text-[18px]">done</span> Better insights</span>
                    <span class="text-gh-fg-dark font-bold text-[15px] flex items-center gap-2"><span class="material-symbols-outlined text-gh-green text-[18px]">done</span> Flexible tracking</span>
                    <span class="text-gh-fg-dark font-bold text-[15px] flex items-center gap-2"><span class="material-symbols-outlined text-gh-green text-[18px]">done</span> Deeper user understanding</span>
                </div>
                <p class="text-[15px] font-bold text-gh-accent bg-gh-accent/10 py-2 px-4 rounded-lg">But only if implemented correctly.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="bg-[#010409] border border-gh-border-dark rounded-2xl p-8 md:p-12 shadow-sm reveal">
            ...
            <div class="space-y-6">
                ...
                <div class="p-4 bg-[#0d1117] border border-gh-border-dark rounded-xl">
                    ...
                    <p class="text-[15px] text-gh-muted-dark pl-8"><strong class="text-gh-fg-dark hover:text-gh-accent transition-colors">→</strong> You don’t know what’s actually working</p>
                </div>
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-[#010409] border border-gh-green/30 rounded-2xl p-8 shadow-sm shadow-gh-green/5 reveal">
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-center gap-3 text-gh-fg-dark font-medium"><span class="text-gh-green">✔</span> Need accurate conversion tracking</li>
                    <li class="flex items-center gap-3 text-gh-fg-dark font-medium"><span class="text-gh-green">✔</span> Want data-driven decisions</li>
                </ul>
            </div>
            ...
            <div class="bg-[#010409] border border-gh-red/20 rounded-2xl p-8 shadow-sm shadow-gh-red/5 reveal reveal-delay-1">
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-center gap-3 text-gh-fg-dark font-medium"><span class="text-gh-red">✘</span> Don’t care about accuracy</li>
                    <li class="flex items-center gap-3 text-gh-fg-dark font-medium"><span class="text-gh-red">✘</span> Not running campaigns</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="grid md:grid-cols-2 gap-16">
            ...
            <div class="reveal reveal-delay-1">
                ...
                <div class="space-y-6 relative before:absolute before:inset-0 before:ml-[11px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-gh-green before:via-gh-blue before:to-gh-inset-dark">
                ...
                <p class="text-[16px] font-bold text-gh-green mt-6">You’ll start seeing accurate data within the first week.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="bg-[#161b22] border border-gh-green/30 rounded-2xl p-8 flex flex-col hover:-translate-y-1 transition-transform relative overflow-hidden reveal reveal-delay-2 shadow-sm shadow-gh-green/5">
                ...
                <ul class="space-y-4 mb-8 flex-grow">
                    <li class="flex items-center gap-3 text-gh-fg-dark font-medium"><span class="material-symbols-outlined text-[18px] text-gh-green">done_all</span> Multi-platform tracking</li>
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-[#0d1117] border border-gh-border-dark rounded-2xl p-8 opacity-70 reveal">
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-center gap-3 text-gh-muted-dark font-medium"><span class="text-gh-border-dark">✖</span> No business understanding</li>
                </ul>
            </div>
            ...
            <div class="bg-[#161b22] border border-gh-green/30 rounded-2xl p-8 shadow-sm shadow-gh-green/5 reveal reveal-delay-1">
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-center gap-3 text-gh-fg-dark font-bold"><span class="material-symbols-outlined text-[18px] text-gh-green">check_circle</span> CRM + Ads integration</li>
                    <li class="flex items-center gap-3 text-gh-fg-dark font-bold"><span class="material-symbols-outlined text-[18px] text-gh-green">check_circle</span> Real attribution clarity</li>
                </ul>
            </div>
        </div>
    </div>
